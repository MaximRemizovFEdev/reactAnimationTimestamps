	...
	timestamps: [
		{
			...
			content: [
				{
					head: "1991",
					text: "Гвидо ван Россум представил в свет язык программирования Python"
				},
				{
					head: "1992",
				...
				{
					head: "1993",
					text: "Приземление корабля Союз ТМ-15. Экипаж посадки — А. Я. Соловьёв, С. В. Авдеев. Длительность полёта составила 188 суток 21 час 41 минуту."
				},
				{
					head: "1994",
					text: "Lorem ipsum4"
